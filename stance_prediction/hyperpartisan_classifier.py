...
a_fn_plt = 'output/NER/hyperpartisan_accuracy.png'
l_fn_plt = 'output/NER/hyperpartisan_loss.png'
a_fn_model = 'output/NER/hyperpartisan_model_accuracy.pth'
l_fn_model = 'output/NER/hyperpartisan_loss.pth'
...
def main():
    # data_dump()
    dataset_train = utils.NewsDataset('hyperpartisan_data_train.json', perform_NER=True, hyperpartisan=True)
    dataloader_train = torch.utils.data.DataLoader(dataset_train, batch_size=batch_size_,
                                                   shuffle=True)
    dataset_val = utils.NewsDataset('hyperpartisan_data_val.json', perform_NER=True, hyperpartisan=True)
